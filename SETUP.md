...
> **Перед стартом — за бажанням перейменуй фізичну теку проекту.** Очікуваний шлях у командах нижче: `D:\project\Shelf`. Якщо в тебе тека називається інакше (наприклад, історичне `D:\project\Polychka`) — або перейменуй у File Explorer (закривши IDE), або підстав свій реальний шлях у командах. На репозиторій це не впливає.
